...
client.on('guildMemberAdd', message =>
          { message.send(`** _Welcome To Vida..._ **`)});
...
client.on('guildMemberAdd', member=> {
    ...
    member.addRole(member.guild.roles.find("Vi"));
...
client.on('guildMemberAdd', member => {
     const welcomer =  member.guild.channels.find('name', '✲-vida');
const w = ['./Welcome Vida.png'];
...
client.on('message', message => {
            ...
            if (message.content === 'ولكم') {
              ...
              message.channel.send('**_ Welcome To Vida 🔥_**');
